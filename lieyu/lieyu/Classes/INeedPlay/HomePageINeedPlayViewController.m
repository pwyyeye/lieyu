        ...
        if (tableView.tag == 0) {
            ...
            if (indexPath.section == 1) {
                ...
                [LYFriendsHttpTool getLiveShowRoomWithParams:dict complete:^(NSDictionary *Arr) {
                    ...
                    if ([Arr[@"coinBoolean"] isEqualToString:@"3"]) {
...
- (void)searchClick:(UIButton *)sender {
    ...
    if (tableView.tag != 2) {//_index != 0 /**/
        ...
        [MTA trackCustomKeyValueEvent:LYCLICK_MTA props:[self createMTADctionaryWithActionName:@"跳转" pageName:HOMEPAGE_MTA titleName:@"搜索直播"]];
    }
}
