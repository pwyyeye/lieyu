...
@interface CHViewController ()<CHShaiXuanDelegate>
{
...
-(UICollectionViewCell *)collectionview:(UICollectionView *)collectionview cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if(!cell){
        [collectionview registerNib:[UINib nibWithNibName:@"CHDetailCollectionCell" bundle:nil] forCellWithReuseIdentifier:@"CHDetailCollectionCell"];
    }
