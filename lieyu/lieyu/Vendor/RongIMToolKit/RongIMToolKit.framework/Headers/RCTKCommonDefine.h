...
/*!
 输入工具栏的显示布局
 */
typedef NS_ENUM(NSInteger, CHRCChatSessionInputBarControlStyle) {
    /*!
     录音切换-输入框-扩展
     */
    CHRC_CHAT_INPUT_BAR_STYLE_SWITCH_CONTAINER_EXTENTION = 0,
    /*!
     扩展-输入框-录音切换
     */
    CHRC_CHAT_INPUT_BAR_STYLE_EXTENTION_CONTAINER_SWITCH = 1,
    /*!
     输入框-录音切换-扩展
     */
    CHRC_CHAT_INPUT_BAR_STYLE_CONTAINER_SWITCH_EXTENTION = 2,
    /*!
     输入框-扩展-录音切换
     */
    CHRC_CHAT_INPUT_BAR_STYLE_CONTAINER_EXTENTION_SWITCH = 3,
    /*!
     录音切换-输入框
     */
    CHRC_CHAT_INPUT_BAR_STYLE_SWITCH_CONTAINER = 4,
    /*!
     输入框-录音切换
     */
    CHRC_CHAT_INPUT_BAR_STYLE_CONTAINER_SWITCH = 5,
    /*!
     扩展-输入框
     */
    CHRC_CHAT_INPUT_BAR_STYLE_EXTENTION_CONTAINER = 6,
    /*!
     输入框-扩展
     */
    CHRC_CHAT_INPUT_BAR_STYLE_CONTAINER_EXTENTION = 7,
    /*!
     输入框
     */
    CHRC_CHAT_INPUT_BAR_STYLE_CONTAINER = 8,
...
/*!
 输入工具栏的菜单类型
 */
typedef NS_ENUM(NSInteger, CHRCChatSessionInputBarControlType) {
    /*!
     默认类型，非公众服务
     */
    CHRCChatSessionInputBarControlDefaultType = 0,
    /*!
     公众服务
     */
    CHRCChatSessionInputBarControlPubType = 1,
    
    /*!
     客服机器人
     */
    CHRCChatSessionInputBarControlCSRobotType = 2,
    
    /*!
     客服机器人
     */
    CHRCChatSessionInputBarControlNoAvailableType = 3
};

/*!
 输入工具栏的输入模式
 */
typedef NS_ENUM(NSInteger, CHRCChatSessionInputBarInputType) {
    /*!
     文本输入模式
     */
    CHRCChatSessionInputBarInputText = 0,
    /*!
     语音输入模式
     */
    CHRCChatSessionInputBarInputVoice = 1,
    /*!
     扩展输入模式
     */
    CHRCChatSessionInputBarInputExtention = 2
};

/*!
 输入工具栏的输入模式
 */
typedef NS_ENUM(NSInteger, CHKBottomBarStatus) {
    /*!
     初始状态
     */
    CHKBottomBarDefaultStatus = 0,
    /*!
     文本输入状态
     */
    CHKBottomBarKeyboardStatus,
    /*!
     功能板输入模式
     */
    CHKBottomBarPluginStatus,
    /*!
     表情输入模式
     */
    CHKBottomBarEmojiStatus,
    /*!
     语音消息输入模式
     */
    CHKBottomBarRecordStatus
};
