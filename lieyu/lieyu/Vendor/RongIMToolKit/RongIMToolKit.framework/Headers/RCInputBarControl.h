 ...
 */
@property(nonatomic) CHRCChatSessionInputBarInputType defaultInputType;

/**
 *  输入框样式，共9中组合，参考枚举RCChatSessionInputBarControlStyle
 */
@property(nonatomic) CHRCChatSessionInputBarControlStyle inputBarStyle;
...
/*!
 ...
 @param frame       显示的Frame
 */
-(void)setInputBarStatus:(CHKBottomBarStatus)Status;
