...
- (instancetype)initWithFrame:(CGRect)frame{
    if(self = [super initWithFrame:frame]){
        _label1 = [[UILabel alloc]initWithFrame:CGRectMake(14, 15, 150, 14)];
        _label1.backgroundColor = [UIColor clearColor];
        _label1.textColor = RGBA(102, 102, 102, 1);
...
- (void)congigure{
        ...
        _label1.text = [NSString stringWithFormat:@"营业时间：(%@ - %@)",self.startTime,self.endTime];
//        
//        UILabel *label2 = [[UILabel alloc]initWithFrame:CGRectMake(SCREEN_WIDTH - 140, 15, 50, 14)];
//        label2.backgroundColor = [UIColor clearColor];
//        label2.textColor = RGBA(102, 102, 102, 1);
