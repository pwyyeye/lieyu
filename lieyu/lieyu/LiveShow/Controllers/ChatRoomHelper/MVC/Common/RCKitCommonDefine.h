...
//请替换成开发者自己的appkey 和 appsecret,为了安全请求token 的过程请放到您自己的服务器来做，避免暴露appkey 和 appsecret
#define RONGCLOUD_IM_APPKEY @"mgb7ka1nbsv8g"
#define RONGCLOUD_IM_APPSECRET @"9jvM3TMYWsMH"
